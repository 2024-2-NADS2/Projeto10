...
Instale o Express
No terminal, execute:
[Texto do Link] npm install express  
...
Instale o Axios
No terminal, execute:
[Texto do Link] npm install axios  
...
Instale o SQLite3
No terminal, execute:
[Texto do Link] npm install sqlite3  
